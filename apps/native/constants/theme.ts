import { dark, light, utilityColors } from '@packages/ui';
import {
...
export const darkTheme = {
    ...MD3DarkTheme,
    colors: {...dark.colors, ...utilityColors}, // Copy it from the color codes scheme and then use it here
};
export const lightTheme = {
    ...MD3LightTheme,
    colors: {...light.colors, ...utilityColors}, // Copy it from the color codes scheme and then use it here
};